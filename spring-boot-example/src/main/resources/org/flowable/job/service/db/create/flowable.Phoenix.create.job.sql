...
alter table ACT_RU_TIMER_JOB dd add constraint ACT_FK_TJOB_CUSTOM_VAL foreign key (CUSTOM_VALUES_ID_) references ACT_GE_BYTEARRAY (ID_);
...
upsert into ACT_GE_PROPERTY values ('job.schema.version', '6.4.0.0', 1);